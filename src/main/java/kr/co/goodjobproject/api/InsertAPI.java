...
public class InsertAPI {
	...
	static final String api = "iuIag2Etf9G4AKsPX8NeAeuNAvVNfJLUMqbJF5FqSx6UnG86UBccK"; // api 인증키
...
//	            String apiURL = "https://oapi.saramin.co.kr/job-search?access-key="+api+"&keyword="+ text;
			String apiURL = "https://oapi.saramin.co.kr/job-search?access-key=iuIag2Etf9G4AKsPX8NeAeuNAvVNfJLUMqbJF5FqSx6UnG86UBccK&bbs_gb=0&job_type=&edu_lv=&loc_cd=101000&fields=posting-date+expiration-date+keyword-code&start="+start+"&count="+end;
...
//				insertCompa(cname, cnt, dao);
	...
	public CompanyDTO insertCompa(String cname, int cnt) throws Exception {
	       ...
	       StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1160100/service/GetCorpBasicInfoService/getCorpOutline"); /*URL*/
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=eSo4ftd4xTnw%2FO920FjCNSlnLwEnIvrcLNHnzvWztZiGZok6YlRnxivIFAlF28nstmguIdiIPHr%2B0HHjB5TJXw%3D%3D"); /*Service Key*/
