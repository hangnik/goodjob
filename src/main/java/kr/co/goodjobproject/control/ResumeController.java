...
//			model.addAttribute("ResumeList",rs.getAll(PrincipalDetails.getCdto().getCno()));
//			model.addAttribute("cno",rs.getAll(PrincipalDetails.getCdto().getCno()));
//		}
